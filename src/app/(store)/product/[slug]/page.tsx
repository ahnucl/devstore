    ...
    <div className="relative grid max-h-[860px] grid-cols-3">
      ...
      <div className="flex flex-col justify-center px-12">
        ...
        <div className="mt-8 space-y-4">
          ...
          <button
            type="button"
            className="mt-8 flex h-12 items-center w-full justify-center rounded-full bg-emerald-600 font-semibold text-white"
          >
